...
from generate_markdown import GenerateMarkdown
from publication_type import PUB_TYPES_BIBTEX_TO_CSL
...
def import_bibtex(
    ...
    from cli import log
    from utils import AcademicError
...
def parse_bibtex_entry(
    ...
    if not dry_run:
        ...
        template = import_resources.read_text("templates", "publication.md")
